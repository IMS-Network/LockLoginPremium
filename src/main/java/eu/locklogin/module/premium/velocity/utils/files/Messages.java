package eu.locklogin.module.premium.velocity.utils.files;

import eu.locklogin.api.module.plugin.javamodule.sender.ModulePlayer;
import eu.locklogin.api.util.platform.CurrentPlatform;
import eu.locklogin.module.premium.velocity.Premium;
...
public class Messages {
    ...
    public final String mojangDown() {
        return messages.getString("MojangDown", "&cMojang servers seems to be down and you were not able to be authenticated");
    }
