package eu.locklogin.module.premium.velocity;

import eu.locklogin.api.module.PluginModule;
import eu.locklogin.api.module.plugin.javamodule.console.MessageLevel;
import eu.locklogin.api.util.platform.CurrentPlatform;
import eu.locklogin.module.premium.velocity.commands.OfflineCommand;
import eu.locklogin.module.premium.velocity.commands.PremiumCommand;
import eu.locklogin.module.premium.velocity.listener.JoinListener;
